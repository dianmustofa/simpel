                    ...
                    <div class="page-title">
                        <div class="row">
                            <div class="col-12 col-md-6 order-md-1 order-last">
                                <h3>Daftar list Isu Lingkungan</h3>
                                    ...
                                    <div class="modal-dialog modal-dialog-scrollable" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalScrollableTitle">Form Isu Lingkungan</h5>
                                            ...
                                            <?php endif; ?>
                                                ...
                                                <div class="modal-body">
                                                    <form action="<?= site_url('setting/simpan_isulingkungan') ?>" method="post" enctype="multipart/form-data">
                                                    <!-- Tambahkan CSS untuk ukuran peta -->

                                                    <div class="form-group">
                                                        <label>Nama Isu Lingkungan</label>
                            ...
                            <div class="card-body">
                                <table class="table table-striped" id="table1">
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($isulingkungan as $row) { 
                                            $idisulingkungan = $row['id_isu'];
                                            $titleisulingkungan = $row['title_isu'];
                                        ?>
                                            <tr>
                                                <td><?= $titleisulingkungan ?></td>
                                                <td>
                                                <?php if (in_array($this->session->userdata('id_level_akun'), [2, 4])) : ?>
                                                    <a href="<?php echo base_url(); ?>isulingkungan/edit/<?= $idisulingkungan ?>">
                                                        <span class="badge bg-secondary" style="cursor: pointer;">Edit</span>
                                                    </a>
                                                    <a href="<?php echo base_url(); ?>setting/delete_isulingkungan/<?= $idisulingkungan ?>">
