...
<head>
    <title>SIMONTER - sumber pendanaan</title>
                    ...
                    <div class="page-title">
                        <div class="row">
                            <div class="col-12 col-md-6 order-md-1 order-last">
                                <h3>Daftar list sumber pendanaan</h3>
                                    ...
                                    <div class="modal-dialog modal-dialog-scrollable" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalScrollableTitle">Form sumber pendanaan</h5>
                                            ...
                                            <?php endif; ?>
                                                ...
                                                <div class="modal-body">
                                                    <form action="<?= site_url('setting/simpan_sumberpendanaan') ?>" method="post" enctype="multipart/form-data">
                                                    <!-- Tambahkan CSS untuk ukuran peta -->

                                                    <div class="form-group">
                                                        <label>Nama sumber pendanaan</label>
                                                        <input type="text" name="title_sumber_pendanaan" placeholder="" class="form-control" required>
                                                    </div>
                            ...
                            <div class="card-body">
                                <table class="table table-striped" id="table1">
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($sumberpendanaan as $row) { 
                                            $idsumberpendanaan = $row['id_sumber_pendanaan'];
                                            $titlesumberpendanaan = $row['title_sumber_pendanaan'];
                                        ?>
                                            <tr>
                                                <td><?= $titlesumberpendanaan ?></td>
                                                <td>
                                                <?php if (in_array($this->session->userdata('id_level_akun'), [2, 4])) : ?>
                                                    <a href="<?php echo base_url(); ?>sumberpendanaan/edit/<?= $idsumberpendanaan ?>">
                                                        <span class="badge bg-secondary" style="cursor: pointer;">Edit</span>
                                                    </a>
                                                    <a href="<?php echo base_url(); ?>setting/delete_sumberpendanaan/<?= $idsumberpendanaan ?>">
