...
<head>
    ...
    <title>SIMONTER - Edit program</title>
                            ...
                            <div class="col-md-12 col-12">
                                <div class="card">
                                    ...
                                    <div class="card-content">
                                        <div class="card-body">
                                            <form class="form form-horizontal" action="<?= site_url('program-update/'.$update_program['id_jenis']) ?>" method="post" enctype="multipart/form-data">
                                                <div class="form-body">
                                                    <div class="row">
                                                        <?php if ($this->session->userdata('logged_in')) : ?>
                                                            ...
                                                            <div class="col-md-8 form-group">
                                                                <textarea type="text" class="form-control" name="title_jenis" required><?php echo isset($update_program['title_jenis']) ? $update_program['title_jenis'] : ''; ?></textarea>
                                                            </div>
