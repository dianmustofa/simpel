...
<head>
    <title>SIMONTER - Aset Lahan</title>
                                    ...
                                    <div class="modal-dialog modal-dialog-scrollable" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalScrollableTitle">Form Aset Lahan</h5>
                                            ...
                                            <?php endif; ?>
                                                ...
                                                <div class="modal-body">
                                                    <form action="<?= site_url('setting/simpan_asetlahan') ?>" method="post" enctype="multipart/form-data">
                                                    <!-- Tambahkan CSS untuk ukuran peta -->

                                                    <div class="form-group">
                                                        <label>Nama Aset Lahan</label>
                                                        <input type="text" name="title_aset_lahan" placeholder="" class="form-control" required>
                                                    </div>
                            ...
                            <div class="card-body">
                                <table class="table table-striped" id="table1">
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($asetlahan as $row) { 
                                            $idAsetLahan = $row['id_aset_lahan'];
                                            $titleAsetLahan = $row['title_aset_lahan'];
                                        ?>
                                            <tr>
                                                <td><?= $titleAsetLahan ?></td>
                                                <td>
                                                <?php if (in_array($this->session->userdata('id_level_akun'), [2, 4])) : ?>
                                                    <a href="<?php echo base_url(); ?>asetlahan/edit/<?= $idAsetLahan ?>">
                                                        <span class="badge bg-secondary" style="cursor: pointer;">Edit</span>
                                                    </a>
                                                    <a href="<?php echo base_url(); ?>setting/delete_asetlahan/<?= $idAsetLahan ?>">
