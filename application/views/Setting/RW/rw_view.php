                                    ...
                                    <div class="modal-dialog modal-dialog-scrollable" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalScrollableTitle">Form RW</h5>
                                            ...
                                            <?php endif; ?>
                                                ...
                                                <div class="modal-body">
                                                    <form action="<?= site_url('setting/simpan_rw') ?>" method="post" enctype="multipart/form-data">
                                                    <!-- Tambahkan CSS untuk ukuran peta -->

                                                    <div class="form-group">
                                                        <label>Nama RW</label>
                                                        <input type="text" name="title_angka" placeholder="" class="form-control" required>
                                                    </div>
                                ...
                                <table class="table table-striped" id="table1">
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($rw as $row) { 
                                            $idrw = $row['id_angka'];
                                            $titlerw = $row['title_angka'];
                                        ?>
                                            <tr>
                                                <td><?= $titlerw ?></td>
                                                <td>
                                                <?php if (in_array($this->session->userdata('id_level_akun'), [2, 4])) : ?>
                                                    <a href="<?php echo base_url(); ?>rw/edit/<?= $idrw ?>">
                                                        <span class="badge bg-secondary" style="cursor: pointer;">Edit</span>
                                                    </a>
                                                    <a href="<?php echo base_url(); ?>setting/delete_rw/<?= $idrw ?>">
