...
<head>
    <title>SIMONTER - pekerjaan</title>
                                    ...
                                    <div class="modal-dialog modal-dialog-scrollable" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalScrollableTitle">Form pekerjaan</h5>
                                            ...
                                            <?php endif; ?>
                                                ...
                                                <div class="modal-body">
                                                    <form action="<?= site_url('setting/simpan_pekerjaan') ?>" method="post" enctype="multipart/form-data">
                                                    <!-- Tambahkan CSS untuk ukuran peta -->

                                                    <div class="form-group">
                                                        <label>Nama pekerjaan</label>
                                                        <input type="text" name="title_pekerjaan" placeholder="" class="form-control" required>
                                                    </div>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                <?php if (in_array($this->session->userdata('id_level_akun'), [2, 4])) : ?>
                                                    <a href="<?php echo base_url(); ?>pekerjaan/edit/<?= $idpekerjaan ?>">
                                                        <span class="badge bg-secondary" style="cursor: pointer;">Edit</span>
                                                    </a>
                                                    <a href="<?php echo base_url(); ?>setting/delete_pekerjaan/<?= $idpekerjaan ?>">
