...
<head>
    ...
    <title>SIMONTER - Edit pekerjaan</title>
                            ...
                            <div class="col-md-12 col-12">
                                <div class="card">
                                    ...
                                    <div class="card-content">
                                        <div class="card-body">
                                            <form class="form form-horizontal" action="<?= site_url('pekerjaan-update/'.$update_pekerjaan['id_pekerjaan']) ?>" method="post" enctype="multipart/form-data">
                                                <div class="form-body">
                                                    <div class="row">
                                                        <?php if ($this->session->userdata('logged_in')) : ?>
                                                            ...
                                                            <div class="col-md-8 form-group">
                                                                <textarea type="text" class="form-control" name="title_pekerjaan" required><?php echo isset($update_pekerjaan['title_pekerjaan']) ? $update_pekerjaan['title_pekerjaan'] : ''; ?></textarea>
                                                            </div>
