...
<head>
    ...
    <title>SIMONTER - Edit kelurahan</title>
                            ...
                            <div class="col-md-12 col-12">
                                <div class="card">
                                    ...
                                    <div class="card-content">
                                        <div class="card-body">
                                            <form class="form form-horizontal" action="<?= site_url('kelurahan-update/'.$update_kelurahan['id_kelurahan']) ?>" method="post" enctype="multipart/form-data">
                                                <div class="form-body">
                                                    <div class="row">
                                                        <?php if ($this->session->userdata('logged_in')) : ?>
                                                            ...
                                                            <div class="col-md-8 form-group">
                                                                <textarea type="text" class="form-control" name="title_kelurahan" required><?php echo isset($update_kelurahan['title_kelurahan']) ? $update_kelurahan['title_kelurahan'] : ''; ?></textarea>
                                                            </div>
