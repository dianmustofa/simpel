...
<head>
    <title>SIMONTER - kelurahan</title>
                                    ...
                                    <div class="modal-dialog modal-dialog-scrollable" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalScrollableTitle">Form kelurahan</h5>
                                            ...
                                            <?php endif; ?>
                                                ...
                                                <div class="modal-body">
                                                    <form action="<?= site_url('setting/simpan_kelurahan') ?>" method="post" enctype="multipart/form-data">
                                                    <!-- Tambahkan CSS untuk ukuran peta -->

                                                    <div class="form-group">
                                                        <label>Nama kelurahan</label>
                                                        <input type="text" name="title_kelurahan" placeholder="" class="form-control" required>
                                                    </div>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                <?php if (in_array($this->session->userdata('id_level_akun'), [2, 4])) : ?>
                                                    <a href="<?php echo base_url(); ?>kelurahan/edit/<?= $idkelurahan ?>">
                                                        <span class="badge bg-secondary" style="cursor: pointer;">Edit</span>
                                                    </a>
                                                    <a href="<?php echo base_url(); ?>setting/delete_kelurahan/<?= $idkelurahan ?>">
